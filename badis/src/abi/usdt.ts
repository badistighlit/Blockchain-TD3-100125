...
export const events = {
    ...
    DestroyedBlackFunds: event("0x61e6e66b0d6339b2980aecc6ccc0039736791f0ccde9ed512e789a7fbdd698c6", "DestroyedBlackFunds(address,uint256)", {"_blackListedUser": p.address, "_balance": p.uint256}),
    AddedBlackList: event("0x42e160154868087d6bfdc0ca23d96a1c1cfa32f1b72ba9ba27b69b98a0d819dc", "AddedBlackList(address)", {"_user": p.address}),
    RemovedBlackList: event("0xd7e9ec6e6ecd65492dce6bf513cd6867560d49544421d0783ddf06e76c24470c", "RemovedBlackList(address)", {"_user": p.address}),
...
export const functions = {
    ...
    transferFrom: fun("0x23b872dd", "transferFrom(address,address,uint256)", {"_from": p.address, "_to": p.address, "_value": p.uint256}, ),
    upgradedAddress: viewFun("0x26976e3f", "upgradedAddress()", {}, p.address),
    balances: viewFun("0x27e235e3", "balances(address)", {"_0": p.address}, p.uint256),
    ...
    allowed: viewFun("0x5c658165", "allowed(address,address)", {"_0": p.address, "_1": p.address}, p.uint256),
    ...
    transfer: fun("0xa9059cbb", "transfer(address,uint256)", {"_to": p.address, "_value": p.uint256}, ),
